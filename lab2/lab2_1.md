...
The mean does not exist because the list of numbers include an "NA" value. This means that having an NA in a list of numbers can affect calculations or commands regarding that list.
...
This is useful because it allows for missing values to be eliminated from lists of numbers so that calculations on the list can be performed.
